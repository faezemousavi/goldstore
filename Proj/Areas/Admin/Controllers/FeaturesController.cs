...
namespace Proj.Areas.Admin.Controllers
{
    public class FeaturesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Feature_id,Feature_title")] Feature feature)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Feature_id,Feature_title")] Feature feature)
        {
            if (ModelState.IsValid)
            {
